...
$payment		 	= $mollie->payments->create(array(
    ...
    "webhookUrl"  => "https://www.slachtemarathon.nl/ticketservice/ticketservice/webhook.php",
));

/*
	$data->paymentID  = $payment->id;
  "redirectUrl" => "http://109.71.51.192/ticketservice/betaald.php?order_id={$data->order_id}",
    "webhookUrl"  => "http://109.71.51.192/ticketservice/webhook.php",
*/
...
$service_url = 'https://www.slachtemarathon.nl/ticketservice/api/freon/storePayment';
