// Generated on 2017-07-26 using generator-angular 0.16.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    pot: {
      files: {
        'po/template.pot': ['app/views/*.html', 'app/views/blokken/*.html', 'app/index.html']
      }
    },
  },
	...
	bower: {
    dev: {
        dest:  '<%= yeoman.dist %>/bower_components'// will get stuff from 'bower_components' to 'lib' folder
    	}
	},
	*/
  ...
  scripts: {
    ...
    useminPrepare: {
      html: ['<%= yeoman.app %>/index.html', '<%= yeoman.app %>/{,*/}*.html'],
      options: {
        dest: '<%= yeoman.dist %>',
        //root: './',
        flow: {
    ...
    usemin: {
      html: ['<%= yeoman.dist %>/{,*/}*.html', '<%= yeoman.dist %>/{,*/}{,*/}*.html', '<%= yeoman.dist %>/{,*/}{,*/}{,*/}*.html'],
